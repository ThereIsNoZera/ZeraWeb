...
const T = {
  en: {
    subtitle:
      "Bilingual visual identity for an international academic conference",
    campaignLabel: "Campaign materials",
    consistency:
      "The identity was applied across various formats and maintained consistency through colour, graphic elements, and bilingual hierarchy.",
    challenge:
      "The main challenge was structuring a large amount of information in both Persian and English clearly, while creating a serious and consistent visual identity.",
    concept:
      "The visual concept combines a globe graphic, geographic markers, and a blue-orange palette to convey internationality, orientation, and academic credibility.",
    impact: "Impact",
  ...
  de: {
    subtitle:
      "Zweisprachiges visuelles Erscheinungsbild für eine internationale akademische Konferenz",
    campaignLabel: "Kampagnenmaterialien",
    consistency:
      "Das Erscheinungsbild wurde auf verschiedene Formate übertragen und blieb durch Farben, grafische Elemente und bilinguale Hierarchie konsistent.",
    challenge:
      "Die größte Herausforderung war, viele Informationen auf Persisch und Englisch klar zu strukturieren und gleichzeitig ein seriöses, konsistentes Erscheinungsbild zu schaffen.",
    concept:
      "Das visuelle Konzept kombiniert eine Globusgrafik, geografische Markierungen und eine blau-orange Farbpalette, um Internationalität, Orientierung und akademische Seriosität zu vermitteln.",
    impact: "Wirkung",
...
export default function ConferenceOverlay({ lang }: { lang: Lang }) {
  ...
  return (
    <div className="bg-[#f0ebe8] relative size-full">
      ...
      {/* Main content */}
      <div className="absolute content-stretch flex flex-col items-start left-[calc(50%-495px)] top-[240px] w-[925px]">
        ...
        <div className="content-stretch flex flex-col items-start mb-[-172px] relative shrink-0 w-full">
          ...
          <div className="content-stretch flex flex-col gap-[16px] items-start mb-[-24px] relative shrink-0 w-[570px]">
            <p className="[word-break:break-word] font-['Space_Grotesk:Bold',sans-serif] font-bold leading-[normal] min-w-full relative shrink-0 text-[#f0ebe8] text-[44px] w-[min-content]">
              The First International Conference on European and American
              Studies
            </p>
            <div className="relative shrink-0 w-full">
              <div className="flex flex-row items-center justify-center size-full">
                <div className="content-stretch flex items-center justify-center px-[5px] relative size-full">
                  <p className="[word-break:break-word] flex-[1_0_0] font-['Poppins:Medium',sans-serif] leading-[normal] min-w-px not-italic relative text-[#1a5c86] text-[18px]">
                    {t.subtitle}
                  </p>
                </div>
              </div>
          ...
          <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full">
            <div className="content-stretch flex gap-[20px] items-end relative shrink-0 w-full">
              ...
              <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-[231px]">
                <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
                  <div className="content-stretch flex gap-[2px] items-center relative shrink-0">
                    ...
                    <p className="[word-break:break-word] font-['Clash_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#333] text-[12px] whitespace-nowrap">
                      {t.campaignLabel}
                    </p>
                  </div>
              ...
              <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-[243px]">
                <p className="[word-break:break-word] font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-black w-full">
                  {t.consistency}
                </p>
        ...
        <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0">
          <p className="[word-break:break-word] font-['Clash_Display:Medium',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#1b1b1b] text-[22px] w-[min-content]">
            {t.impact}
          </p>
          <div className="content-stretch flex items-center justify-center pl-[27px] relative shrink-0 w-[544px]">
            <ul className="[word-break:break-word] block font-['Poppins:Regular',sans-serif] leading-[0] list-disc not-italic relative shrink-0 text-[16px] text-black w-[517px]">
              <li className="mb-[6px] ms-[24px]">
                <span className="leading-[normal]">{t.b1}</span>
              </li>
              <li className="mb-[6px] ms-[24px]">
                <span className="leading-[normal]">{t.b2}</span>
              </li>
              <li className="ms-[24px]">
                <span className="leading-[normal]">{t.b3}</span>
              </li>
            </ul>
          </div>
          <div className="content-stretch flex gap-[20px] items-end relative shrink-0">
            ...
            <div className="content-stretch flex flex-col gap-[29px] items-start justify-center relative shrink-0">
              <ul className="[word-break:break-word] block font-['Poppins:Regular',sans-serif] leading-[0] list-disc min-w-full not-italic relative shrink-0 text-[16px] text-black w-[min-content]">
                <li className="mb-[6px] ms-[24px]">
                  <span className="leading-[normal]">{t.b4}</span>
                </li>
                <li className="ms-[24px]">
                  <span className="leading-[normal]">{t.b5}</span>
                </li>
              </ul>
              <div className="content-stretch flex gap-[20px] items-start relative shrink-0">
