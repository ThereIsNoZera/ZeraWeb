...
const T = {
  en: {
    subtitle: "Learning game prototype for children with autism",
    ...
    roleLabel: "My role:",
    roleContent:
      "Concept development, Research, Interviews, Illustration, Presentation design, Scratch prototype",
    typeLabel: "Type:",
    ...
    medalCaption:
      "Silver Medal, Khwarazmi Youth Award 2023, Cognitive Sciences category. Submitted as a research and competition project together with a fellow student.",
    testCaption: "Testing the Scratch prototype",
    testBody:
      "The prototype was tested by around ten children from participating schools and clinics. Teachers and parents gave consistently positive feedback — particularly on the audio narration and ease of navigation for this target group.",
    gameCaption:
      "Five social scenarios, each as a two-option mini-game; designed around Carol Gray's Social Stories framework.",
  },
  de: {
    ...
    roleContent:
      "Konzeptentwicklung, Recherche, Interviews, Illustration, Präsentationsdesign, Scratch-Prototyp",
    typeLabel: "Art:",
    ...
    medalCaption:
      "Silbermedaille, Khwarazmi-Jugendwettbewerb 2023, Kategorie Kognitive Wissenschaften. Eingereicht als Forschungs- und Wettbewerbsprojekt gemeinsam mit einer Kommilitonin.",
    testCaption: "Test des Scratch-Prototyps",
    testBody:
      "Der Prototyp wurde von rund zehn Kindern aus beteiligten Schulen und Kliniken getestet. Lehrkräfte und Eltern gaben durchweg positives Feedback. Besonders zur Audio-Erzählung und zur einfachen Navigierbarkeit für diese Zielgruppe.",
    gameCaption:
      "Five social scenarios, each as a two-option mini-game; designed around Carol Gray's Social Stories framework.",
  },
} as const;
        ...
        <div className="content-stretch flex flex-col gap-[22px] items-start relative shrink-0 w-full">
          ...
          <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-[364px]">
            <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-black w-full">
              <p className="font-['Clash_Display:Medium',sans-serif] leading-[normal] min-w-full relative shrink-0 text-[22px] w-[min-content]">
                {t.outcome}
              </p>
          ...
          <div className="content-stretch flex flex-col gap-[7px] items-start relative shrink-0 w-[239px]">
            ...
            <div className="relative shrink-0 w-full">
              <div className="content-stretch flex gap-[4px] items-start px-[4px] relative size-full">
                <CaptionTriangle />
                <p className="[word-break:break-word] font-['Clash_Display:Regular',sans-serif] leading-[normal] min-w-px not-italic relative text-[12px] text-black">
                  {t.testCaption}
                </p>
              </div>
            </div>
        ...
        <div className="content-stretch flex flex-col items-center relative shrink-0 w-[337px]">
          ...
          <div className="h-[45px] relative shrink-0 w-full">
            <div className="content-stretch flex gap-[4px] items-start px-[29px] relative size-full">
              ...
              <p className="[word-break:break-word] font-['Clash_Display:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12px] text-black w-[275px]">
                {t.gameCaption}
              </p>
            </div>
          </div>
