...
function Frame() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[180px] h-full items-center min-w-px relative">
      <div
        className="aspect-[285/191] relative shrink-0 w-full"
        data-name="Raffle Page 1-1 1 1"
      >
        <img
          alt=""
          className="absolute inset-0 max-w-none object-cover pointer-events-none size-full"
          src={imgRafflePage1111}
        />
      </div>
      <div
        className="aspect-[285/234] relative shrink-0 w-full"
        data-name="1280toCrop 1 1"
      >
        <img
          alt=""
          className="absolute inset-0 max-w-none object-cover pointer-events-none size-full"
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[180px] h-full items-center min-w-px relative">
      <div
        className="aspect-[285/190] relative shrink-0 w-full"
        data-name="2 1 1"
      ></div>
      <div
        className="aspect-[285/234] relative shrink-0 w-full"
        data-name="Create Raffle 1-2 (2) 1 1"
      >
        <img
          alt=""
          className="absolute inset-0 max-w-none object-cover pointer-events-none size-full"
          src={imgCreateRaffle12211}
        />
      </div>
    </div>
  );
