...
export default function Frame({
  ...
  return (
    <div
      className={
        className ||
        `relative rounded-[5px] ${isVariant2 ? "bg-[#b2b1a9]/10" : "bg-[rgba(255,255,255,0.01)]"}`
      }
    >
      ...
      <div
        aria-hidden
        className={`absolute z-2 border-2 border-black border-solid inset-0 pointer-events-none rounded-[5px] ${isVariant2 ? "" : "shadow-[-3px_3px_0px_0px_rgba(0,0,0,0.4)]"}`}
      />
    </div>
  );
}
